...
import 'package:todofreezed/helpers/colors.dart';
import 'package:todofreezed/models/tudo_model.dart';
import 'package:todofreezed/view/add_todo.dart';
import 'package:todofreezed/view/edit_page.dart';
                ...
                itemBuilder: (context, index) {
                  ...
                  return Slidable(
                       endActionPane:
                          ...
                          SlidableAction (
                            onPressed: (context) {
                        homedatas.deleteitems(context,item.id.toString());
                        homedatas.refreshData();
                            },
